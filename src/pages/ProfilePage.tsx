      ...
      <div className="profile-header__main">
        ...
        <div className="profile-header__actions">
          {isOwn ? (
            ...
            <>
              <button className="btn btn--outline btn--sm" onClick={() => setAppTab('notifications')}>
                Message
              </button>
              <button className="btn btn--primary btn--sm" onClick={() => toggleFollowUser(user.id)}>
      ...
      {user.skills.map(skill => (
        <div key={skill.id} className="skill-item">
          ...
          <div className="skill-bar">
            <div className="skill-bar__fill" style={{ width: `${SkillLevelMap[skill.level]}%` }} />
          </div>
        </div>
      ))}
    </div>
...
useEffect(() => {
  ...
  {activeTab === 'overview' && (
    <div className="profile-section">
      <h3 className="profile-section__title text-display">
        My Posts
      </h3>
